(function () {
  ...
  const docs = [
    ...
    'esocore-edge.md',                    // Hardware: Edge
    'esocore-sensors.md',                 // Hardware: Sensors
    ...
    'development-timeline.md',            // Development Timeline
  ...
  const icons = {
    ...
    'cloud-infrastructure': '<svg aria-hidden="true" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 10h-1.26A8 8 0 1 0 9 20h9a5 5 0 0 0 0-10z"/><path d="M12 2v6m0 0l-3-3m3 3 3-3"/></svg>',
    ...
    'development-timeline': '<svg aria-hidden="true" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>',
  ...
  function titleFromName(name) {
    ...
    if (name === 'EsoCore-core.md') return 'Hardware: Core';
    if (name === 'EsoCore-sensors.md') return 'Hardware: Sensors';
    if (name === 'cloud-infrastructure.md') return 'Cloud Infrastructure';
    return name
      .replace(/\-/g, ' ')
      .replace(/\.md$/, '')
