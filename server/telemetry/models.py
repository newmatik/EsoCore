...
class TelemetryPacket(models.Model):
    ...
    device = models.ForeignKey(Device, on_delete=models.CASCADE, related_name='telemetry_packets')
...
class TelemetryWindow(models.Model):
    ...
    id = models.BigAutoField(primary_key=True)
    device = models.ForeignKey(Device, on_delete=models.CASCADE, related_name='telemetry_windows')
    timestamp = models.DateTimeField()
    metric = models.CharField(max_length=255)
