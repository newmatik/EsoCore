...
class AssetSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Asset
        fields = [
            'id', 'asset_id', 'site', 'site_name', 'asset_type', 'make', 'model',
            'serial_number', 'installation_date', 'location', 'specifications',
            'tags', 'is_active', 'cycle_count', 'created_at', 'updated_at'
        ]
...
class AssetCycleSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = AssetCycle
        fields = [
            'id', 'asset', 'asset_name', 'cycle_type', 'start_time',
            'end_time', 'duration', 'metadata', 'created_at'
        ]
