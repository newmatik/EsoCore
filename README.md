...
## 1) Project goals (definition of done)
...
graph TD
    %% Sensors and Inputs
    TempSensor["Ambient Temp/RH"]
    StatorTemp["Stator Temperature"]
    ...
    %% Edge Processing
    STM32["STM32 MCU<br/>F4/F7/H7"]
    Sampling["Sampling &<br/>Feature Extraction"]
    RingBuffer["Local Ring<br/>Buffers"]
    SDCard["SD Card<br/>Storage"]
    
    %% Connectivity
    SyncAgent["Sync Agent<br/>(REST)"]
    TLS["TLS"]
    Network["Ethernet/WiFi"]
    
    %% Cloud Platform
    CloudAPI["Cloud API<br/>(Frappe)"]
    Auth["Auth &<br/>Device Registry"]
    DataIngest["Data Ingest<br/>& Validation"]
    Database["Time Series<br/>Database"]
    Dashboard["Dashboards<br/>& Alerts"]
    ...
    class TempSensor,StatorTemp,Vibration,Audio,Current,Cycles sensor
    class STM32,Sampling,RingBuffer,SDCard,SyncAgent,TLS,Network edge
    class CloudAPI,Auth,DataIngest,Database,Dashboard cloud
```
...
Detailed Specifications: See [Hardware Requirements](docs/hardware-requirements.md) for complete component specifications, compliance standards, and reference designs.

---

## 4) Firmware architecture (edge device)
...
Detailed Specifications: See [Data Format Specification](docs/data-format-specification.md) for complete JSON schemas, event types, and file structure details.
...
Detailed Specifications: See [Edge Intelligence Documentation](docs/edge-intelligence.md) for complete TinyML model specifications, training pipelines, and performance benchmarks.
...
Detailed Specifications: See [API Specification](docs/api-specification.md) for complete REST API documentation, authentication methods, and sync protocols.
...
Detailed Specifications: See [API Specification](docs/api-specification.md) for complete platform architecture, database design, and integration details.
...
**Safety & Compliance**: EN ISO 13849 functional safety validation, EMC testing, and environmental qualification testing.

Detailed Procedures: See [Testing Procedures](docs/testing-procedures.md) for complete test protocols, acceptance criteria, and validation procedures.
...
This README provides the business case and system overview. Detailed technical specifications are organized in separate documents:

### Core Specifications

- **[Hardware Requirements](docs/hardware-requirements.md)** - Complete component specifications, safety standards, and compliance requirements
- **[Data Format Specification](docs/data-format-specification.md)** - JSON schemas, event types, file structures, and data integrity protocols
- **[API Specification](docs/api-specification.md)** - REST API documentation, authentication, cloud platform architecture
- **[Edge Intelligence](docs/edge-intelligence.md)** - TinyML models, AI algorithms, training pipelines, and performance benchmarks

### Development & Operations

- **[Business Model & Partnerships](docs/business-model-and-partnerships.md)** - Development model, funding structure, open source philosophy, and partnership framework
- **[Competitor Analysis](docs/competitor-analysis.md)** - Market landscape, competitive positioning, and strategic differentiation in industrial doors and CNC machine monitoring
- **[Development Timeline & Budget](docs/development-timeline-budget.md)** - Project phases, effort breakdown, resource requirements, and cost analysis
- **[Testing Procedures](docs/testing-procedures.md)** - Comprehensive testing protocols, validation procedures, and acceptance criteria
